...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'dummyText' })
...
export default async function DummyTextPage({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
  ...
  const jsonLd = [
    {
      ...
      featureList: [t('seo.privacy'), ...useCases],
      inLanguage: locale,
      isPartOf: {
        '@type': 'WebSite',
